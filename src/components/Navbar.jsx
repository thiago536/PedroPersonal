        ...
        <nav className={cn(
            ...
            <div className="container mx-auto px-4 flex justify-between items-center">
                <div className="flex flex-col">
                    <a href="#" className="text-2xl font-display font-bold text-white tracking-wider leading-none">
                ...
                <div className="hidden md:flex space-x-8 items-center">
                    ...
                    <a
                        href="https://wa.me/5583999373803?text=Olá Pedro, quero começar agora!"
                        target="_blank"
