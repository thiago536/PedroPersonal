...
const audience = [
    {
        ...
        text: "VocÃª nÃ£o precisa estar em forma para comeÃ§ar. Meu foco Ã© ensinar a tÃ©cnica correta para vocÃª ganhar confianÃ§a na academia."
    },
    {
        icon: Clock,
    ...
    },
    {
        ...
        text: "Foco total na biomecÃ¢nica e seguranÃ§a articular. O objetivo Ã© fortalecer seu corpo, prevenindo dores e lesÃµes."
    }
];
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <h3 className="text-4xl md:text-5xl font-display font-bold text-white">
                        ESTE TREINO Ã‰ PARA <span className="text-neon-blue">VOCÃŠ SE...</span>
                    </h3>
                </div>
