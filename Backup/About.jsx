...
const features = [
    {
        icon: Smartphone,
        title: "Consultoria Online/HÃ­brida",
        subtitle: "Atendimento onde vocÃª estiver."
    },
    {
        icon: Star,
        title: "Atendimento Exclusivo",
        subtitle: "Vagas limitadas para mÃ¡xima atenÃ§Ã£o."
    },
    {
        icon: Activity,
    ...
    {
        icon: MessageCircle,
        title: "Suporte DiÃ¡rio",
        subtitle: "Tire dÃºvidas e corrija movimentos."
    },
];
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="relative rounded-3xl overflow-hidden aspect-[4/5] group">
                            <img
                                ...
                                alt="Pedro Silva Personal Trainer focando na execuÃ§Ã£o correta do movimento"
                    ...
                    >
                        ...
                        <h3 className="text-fluid-h2 font-display font-bold text-white mb-6">
                            ...
                            UMA <span className="text-neon-blue">TRANSFORMAÃ‡ÃƒO</span>
                        </h3>
                        <p className="text-gray-400 text-lg leading-relaxed mb-8">
                            Meu nome Ã© Pedro Silva. Sou especialista em biomecÃ¢nica e fisiologia do exercÃ­cio. Minha missÃ£o Ã© levar vocÃª ao seu melhor fÃ­sico, respeitando sua individualidade biolÃ³gica e rotina. NÃ£o vendo apenas fichas de treino, entrego um estilo de vida novo.
                        </p>
