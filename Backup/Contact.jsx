                ...
                <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <h3 className="text-fluid-h2 font-display font-bold text-white mb-6">
                            VAMOS <span className="text-neon-orange">COMEÃ‡AR?</span>
                        </h3>
                        <p className="text-gray-400 text-lg mb-8">
                            Pronto para levar seu treino para o prÃ³ximo nÃ­vel? Entre em contato direto pelas redes sociais ou envie uma mensagem.
                        </p>
                        ...
                        <div className="space-y-6">
                            ...
                            <a
                                href="https://wa.me/5583999373803?text=OlÃ¡ Pedro, vi seu site e gostaria de saber mais."
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-4 text-white hover:text-neon-orange transition-colors group"
                            >
                 ...
                 Given the user request to be "interactive" but "stateless (vercel)", redirecting the form submit to WhatsApp is a clever hack. */}
                        ...
                        <button
                            ...
                            onClick={() => {
                                ...
                                const text = `OlÃ¡ Pedro, me chamo ${name} e meu objetivo Ã© ${goal}. Gostaria de mais informaÃ§Ãµes.`;
